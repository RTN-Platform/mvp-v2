  ...
  return (
    <MainLayout>
      <div className="space-y-6">
        ...
        {/* When there's no child route (path is exactly /admin), show the dashboard cards */}
        {window.location.pathname === "/admin" && (
          <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
            ...
            <Card>
              <CardHeader>
                <CardTitle className="flex items-center gap-3">
                  <Home className="h-6 w-6 text-nature-700" />
                  Listing Management
                </CardTitle>
                <CardDescription>View and manage all host listings</CardDescription>
              </CardHeader>
              <CardContent className="flex justify-end">
                <Button asChild variant="secondary">
                  <Link to="/admin/content">Manage Listings</Link>
                </Button>
              </CardContent>
            </Card>
